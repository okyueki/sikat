...
class PeraturanDirekturPdfService
{
    private static function config(): SignableDocumentConfig
    {
        return new SignableDocumentConfig(
            storageFolder: 'peraturan_direktur',
            verifyRouteName: 'peraturan_direktur.verify',
            auditModule: 'peraturan_direktur',
            tempPrefix: 'peraturan_direktur_',
            numberPrefix: "RS'ASF/PER",
            documentLabel: 'Peraturan Direktur',
            routePrefix: 'peraturan_direktur',
            hasMasaBerlaku: true,
        );
    }
    ...
    public static function generateSignedPdfContent(PeraturanDirektur $doc, bool $embedVerificationAssets = false): string
    {
    ...
    public static function generateSignedPdf(PeraturanDirektur $doc): Response
    {
