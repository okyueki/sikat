        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <form action="{{ route('ijin.store') }}" method="POST" enctype="multipart/form-data" id="form-ijin">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control flatpickr" value="{{ old('tanggal_awal') }}">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_akhir" id="tanggal_akhir" class="form-control flatpickr" value="{{ old('tanggal_akhir') }}">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
