...
<li class="slide">
                                ...
                                <li class="slide">
                                    <a href="{{ route('memo_internal.index') }}" class="side-menu__item {{ request()->routeIs('memo_internal.*') ? 'active' : '' }}">Coba MI</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('surat_edaran.index') }}" class="side-menu__item {{ request()->routeIs('surat_edaran.*') ? 'active' : '' }}">Surat Edaran</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('peraturan_direktur.index') }}" class="side-menu__item {{ request()->routeIs('peraturan_direktur.*') ? 'active' : '' }}">Peraturan Direktur</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('keputusan_direktur.index') }}" class="side-menu__item {{ request()->routeIs('keputusan_direktur.*') ? 'active' : '' }}">Keputusan Direktur</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ route('spo.index') }}" class="side-menu__item {{ request()->routeIs('spo.*') ? 'active' : '' }}">SPO</a>
                                </li>
                        ...
                        <!-- Start::slide -->
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item {{ request()->routeIs('acara_*') || request()->routeIs('backend_acara') || request()->routeIs('absensi_agenda.*') || request()->routeIs('rekap-absensi') || request()->routeIs('masjid_token.*') || request()->routeIs('rekap_absensi_sholat.*') ? 'active' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide has-sub">
                                    ...
                                    <ul class="slide-menu child2">
                                        ...
                                        <li class="slide">
                                            <a href="{{ route('presensi.index') }}" class="side-menu__item {{ request()->routeIs('presensi.index') || request()->routeIs('presensi.verifikasi') ? 'active' : '' }}">Temporary Presensi</a>
                                        </li>
                                        @endcan
                                        @can('rekap.view')
                                        <li class="slide">
                                            <a href="{{ route('presensi.foto_absensi') }}" class="side-menu__item {{ request()->routeIs('presensi.foto_absensi') ? 'active' : '' }}">Foto Absensi</a>
                                        </li>
                                        @endcan
                                        @can('insightface.admin')
                                        <li class="slide">
                                            <a href="{{ route('insightface.index') }}" class="side-menu__item {{ request()->routeIs('insightface.*') ? 'active' : '' }}">InsightFace Wajah</a>
                                        </li>
                                        @endcan
                                        <li class="slide">
