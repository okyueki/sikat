...
if ('serviceWorker' in navigator) {
    // Batasi hanya untuk halaman /mobile agar tidak mengganggu area lain (admin, dll).
    if (window.location.pathname.startsWith('/mobile')) {
        // SW disimpan di root, scope dibatasi ke /mobile/
        navigator.serviceWorker.register('/sw-mobile.js', { scope: '/mobile/' })
