            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('ijin.update', $pengajuanLibur->id_pengajuan_libur)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control flatpickr" value="<?php echo e(old('tanggal_awal', $pengajuanLibur->tanggal_awal)); ?>">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_akhir" id="tanggal_akhir" class="form-control flatpickr" value="<?php echo e(old('tanggal_akhir', $pengajuanLibur->tanggal_akhir)); ?>">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="keterangan" id="keterangan" class="form-control" value="<?php echo e(old('keterangan', $pengajuanLibur->keterangan)); ?>">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="foto">Upload Foto Bukti:</label>
                                    <input type="file" name="file" id="myDropify" 
                                    data-default-file="<?php echo e($pengajuanLibur->foto ? asset('storage/' . $pengajuanLibur->foto) : ''); ?>"/>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="nik_atasan_langsung" id="nik_atasan_langsung" class="form-control">
                                        ...
                                        <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($p->nik); ?>" <?php echo e($p->nik == old('nik_atasan_langsung', $pengajuanLibur->nik_atasan_langsung) ? 'selected' : ''); ?>>
                                                <?php echo e($p->nama); ?>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/ijin/edit.blade.php ENDPATH**/ ?>