    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('absensi_event.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="nik" id="nik" class="form-control">
                            ...
                            <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pegawai->nik); ?>"><?php echo e($pegawai->nik); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="agenda_id" id="agenda_id" class="form-control">
                            <?php $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($agenda->id); ?>"><?php echo e($agenda->judul); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/absensi_event/create.blade.php ENDPATH**/ ?>