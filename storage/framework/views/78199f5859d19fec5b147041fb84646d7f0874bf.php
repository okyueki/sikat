        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-body">
                        <a href="<?php echo e(route('cuti.create')); ?>" class="btn btn-success waves-effect waves-light mb-3">Create Cuti</a>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/cuti/index.blade.php ENDPATH**/ ?>