                            ...
                            <div class="tab-pane active" id="home" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="btn btn-info waves-effect waves-light edit" href="<?php echo e(route('surat_masuk.edit', $surat->id_surat)); ?>"><i class="far fa-edit"></i> Edit Surat</a>
                                        <form action="<?php echo e(route('surat_masuk.destroy', $surat->id_surat)); ?>" method="POST" style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-lg-12">
                                    <?php if($surat->verifikasi): ?>
    <form action="<?php echo e(route('surat_masuk.verifikasiProses', $surat->verifikasi->id_verifikasi_surat)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="nik_atasan_langsung" id="nik_atasan_langsung" class="form-control">
                                                ...
                                                <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if($atasanLangsung && $atasanLangsung->nik_verifikator == $p->nik): ?>
                                                            selected
                                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/surat_masuk/verifikasi.blade.php ENDPATH**/ ?>