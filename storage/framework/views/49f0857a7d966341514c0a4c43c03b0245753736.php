...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo e(asset('assets/libs/choices.js/public/assets/styles/choices.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/flatpickr/flatpickr.min.css')); ?>">
        <link href="<?php echo e(asset('assets/css/app.min.css')); ?>" id="app-style" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(asset('assets/libs/dropify/dist/dropify.min.css')); ?>">
        ...
        <script src="<?php echo e(asset('assets/libs/dropify/dist/dropify.min.js')); ?>"></script>
        
        <style>
            .choices {
                z-index: 1000; /* Higher value to make sure dropdown is on top */
            }
            .dz-progress {
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('assets/images/logo-sm.svg')); ?>" alt="" height="24"> <span class="logo-txt"><?php echo e(config('app.name', 'Laravel')); ?></span>
                                </span>
                            </a>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="<?php echo e(asset('assets/images/users/avatar-1.jpg')); ?>"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo e(Auth::user()->name ?? 'Tamu'); ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" ><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © <?php echo e(config('app.name', 'Laravel')); ?>.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Develop by <a href="#!" class="text-decoration-underline">Unit IT</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>