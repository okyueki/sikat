        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="row gy-4">
                    ...
                    <form action="<?php echo e(route('cuti.update', $cuti->id_pengajuan_libur)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <input type="hidden" name="jumlah_hari" id="jumlah_hari" class="form-control" value="<?php echo e(old('jumlah_hari', $pengajuanLibur->jumlah_hari ?? '')); ?>">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="jenis_pengajuan_libur" id="jenis_pengajuan_libur" class="form-control">
                                    ...
                                    <?php $__currentLoopData = ['Tahunan', 'Melahirkan', 'Ambil Libur', 'Menikah']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenis); ?>" <?php echo e((old('jenis_pengajuan_libur', $cuti->jenis_pengajuan_libur ?? '') == $jenis) ? 'selected' : ''); ?>>
                                            <?php echo e($jenis); ?>
                                ...
                                <div class="row">
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control flatpickr" value="<?php echo e(old('tanggal_awal', $cuti->tanggal_awal ?? '')); ?>">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
                                    <div class="col-5 mb-3">
                                        <div class="input-group">
                                            <input type="text" name="tanggal_akhir" id="tanggal_akhir" class="form-control flatpickr" value="<?php echo e(old('tanggal_akhir', $cuti->tanggal_akhir ?? '')); ?>">
                                            <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="keterangan" id="keterangan" class="form-control" value="<?php echo e(old('keterangan', $cuti->keterangan ?? '')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="alamat" id="alamat" class="form-control"><?php echo e(old('alamat', $cuti->alamat ?? '')); ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="nik_atasan_langsung" id="nik_atasan_langsung" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->nik); ?>" <?php echo e($cuti->nik_atasan_langsung === $p->nik ? 'selected' : ''); ?>><?php echo e($p->nama); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/cuti/edit.blade.php ENDPATH**/ ?>