...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-body">
                <form action="<?php echo e(route('ubahpassword.update')); ?>" method="POST" id="passwordForm">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/auth/ubahpassword.blade.php ENDPATH**/ ?>