                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element messages-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                            ...
                            <span class="badge rounded-pill bg-danger" id="notif-count">0</span>
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message" data-popper-placement="none">
                            <div class="menu-header-content bg-primary text-fixed-white">
                                ...
                                <p class="dropdown-title-text subtext mb-0 text-fixed-white op-6 pb-0 fs-12 ">
                                    Pesan yang belum dibaca (<span id="notif-count-text">0</span>)
                                </p>
                            </div>
                            <div><hr class="dropdown-divider"></div>
                            <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                                <li class="dropdown-item px-3">Loading...</li>
                            </ul>
                            <div class="text-center dropdown-footer">
                                <a href="<?php echo e(route('surat_masuk.index')); ?>" class="text-primary fs-13">VIEW ALL</a>
                            </div>
                        </div>
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                            <li>
                                <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 lh-1 text-fixed-white"><?php if(Auth::check()): ?>
    <?php echo e(Auth::user()->name); ?>

<?php endif; ?></h6><span class="fs-11 op-7 lh-1">Premium Member</span>
                                    </div>
                                </div>
                            </li>
                            <li><a class="dropdown-item d-flex" href="<?php echo e(route('profil.show')); ?>"><i class="bx bx-user-circle fs-18 me-2 op-7"></i>Profile</a></li>

                            <li><a class="dropdown-item d-flex" href="<?php echo e(route('kepegawaian.rekap_presensi.index')); ?>"><i class="bx bx-cog fs-18 me-2 op-7"></i>Rekap Presensi </a></li>
                            ...
                            <li><a class="dropdown-item d-flex border-block-end" href="<?php echo e(route('ubahpassword.index')); ?>"><i class="bx bx-slider-alt fs-18 me-2 op-7"></i>Ubah Password</a></li>
                            <li><a class="dropdown-item d-flex" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Sign Out</a>
        ...
        </header><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/layouts/backend/header.blade.php ENDPATH**/ ?>