        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <form action="<?php echo e(route('cuti.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="jenis_pengajuan_libur" id="jenis_pengajuan_libur" class="form-control">
                                    ...
                                    <?php $__currentLoopData = ['Tahunan', 'Melahirkan', 'Ambil Libur', 'Menikah']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenis); ?>" <?php echo e((old('jenis_pengajuan_libur', $pengajuanLibur->jenis_pengajuan_libur ?? '') == $jenis) ? 'selected' : ''); ?>>
                                            <?php echo e($jenis); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="row">
                                    ...
                                    </div> <!-- Tag penutup yang kurang ada di sini -->
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.pages-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sikat.rsaisyiyahsitifatimah.com/resources/views/cuti/create.blade.php ENDPATH**/ ?>